...
def test_no_sb1(null: pd.DataFrame) -> None:
    """Vérifie que la fonction control._check_sb1 renvoit le DataFrame original si aucune ligne ne
...
def test_no_sb2(null: pd.DataFrame) -> None:
    """Vérifie que la fonction control._check_sb2 renvoit le DataFrame original si aucune ligne ne
    correspond aux critères
...
def test_no_sb3(null: pd.DataFrame) -> None:
    """Vérifie que la fonction control._check_sb3 renvoit le DataFrame original si aucune ligne ne
    correspond aux critères
